...
public class CreditCardTest {
    ...
    void creditCardLimits_OK(){
        ...
        assertEquals(BigDecimal.valueOf(100),creditCard.getCreditLimit());
        creditCard.setCreditLimit(BigDecimal.valueOf(100000));
        assertEquals(BigDecimal.valueOf(100000),creditCard.getCreditLimit());
        assertThrows(IllegalArgumentException.class,() -> creditCard.setCreditLimit(BigDecimal.valueOf(99)));
        assertThrows(IllegalArgumentException.class,() -> creditCard.setCreditLimit(BigDecimal.valueOf(100001)));
    }
    @Test
